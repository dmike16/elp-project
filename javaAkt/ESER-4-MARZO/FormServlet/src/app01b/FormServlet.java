...
public class FormServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request,
        ...
        writer.println("<form method='post' action='form'>");
    ...
    */
    ...
    public void doPost(HttpServletRequest request,
        ...
        writer.println("<br>");
        writer.println("<a href='OrderForm.html' >Modulo ordine </a>");
        ...
        */  
    	...
    	if (request.getParameter("name")==null||request.getParameter("name").length()==0) {
    		String s = "Dati errati";
    		request.setAttribute("errore", s);
            RequestDispatcher rd = 
                    request.getRequestDispatcher("/OrderForm.jsp");
            rd.forward(request, response);
    	} else {
    		request.setAttribute("bello", "Bello! Ha funzionato!");
            RequestDispatcher rd = 
                    request.getRequestDispatcher("/FormOutput.jsp");
            rd.forward(request, response);
    	}
		*/
    }
