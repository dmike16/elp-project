...
public class TicketServlet extends HttpServlet{
            ...
            throws ServletException,IOException
    {
        ...
        writer.append("<p><label>Your Name\r\n");
        writer.append("<input type=\"text\" name=\"customerName\"/></label></p>\r\n");
        writer.append("<p><label>Subject\r\n");
        writer.append("<input type=\"text\" name=\"subject\"/></label></p>\r\n");
        writer.append("<p><label>Body\r\n");
        writer.append("<textarea name=\"body\" rows=\"5\" cols=\"30\">")
              .append("</textarea></label></p>\r\n");
        writer.append("<p><label><b>Attachments</b>\r\n");
        writer.append("<input type=\"file\" name=\"file1\"/></label></p>\r\n");
        writer.append("<button type=\"submit\" role=\"button\">Submit</button\r\n");
        writer.append("</form>\r\n");
            ...
            throws ServletException,IOException
    {
        ...
        if(this.ticketDb.isEmpty()){
            writer.append("<i>There are no tickets in the system.</i>\r\n");
        } else {
            this.ticketDb.keySet().stream().forEach((id) -> {
    ...
    private Attachment processAttachment(Part filePart)
            throws IOException
    {
        InputStream inputStram = filePart.getInputStream();
        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
        
        int read;
        final byte[] bytes = new byte[1024];
        
        while((read = inputStram.read(bytes)) != -1){
            ...
            throws ServletException,IOException
    {
        ...
        writer.append("<!DOCTYPE html>\r\n")
                .append("<html>\r\n")
                .append("   <head>\r\n")
                .append("       <title>Customer Support Page</title>\r\n")
                .append("   </head>\r\n")
                .append("   <body>\r\n");
        return writer;
    }
