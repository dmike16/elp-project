...
set CLASSPATH=%APP_HOME%\lib\SortMethod-0.1.0.jar

@rem Execute example
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %EXAMPLE_OPTS%  -classpath "%CLASSPATH%" ex.dmike.algostructure.EntryPoint %CMD_LINE_ARGS%
